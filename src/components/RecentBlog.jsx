    ...
    <main className='mt-8'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-y-8 gap-x-0 lg:gap-x-8 justify-center items-center'>
        ...
        {recentBlog.slice(0, 1).map((post) => (
          <div key={post.key} className='col-span-1 md:col-span-2 lg:col-span-1 row-span-1 md:row-span-2'>
        ...
        {recentBlog.slice(1, 3).map((post) => (
          <>
            <article key={post.key} className='lg:col-span-1 col-span-2 group p-4 md:p-2 lg:p-0   overflow-hidden'>
        ...
        {recentBlog.slice(3,4).map((post) => (
          <article key={post.key} className='lg:col-span-2 col-span-2 group p-4 md:p-2 lg:p-0 '>
